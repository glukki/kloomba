...
DESCRIPTOR = descriptor.FileDescriptor(
  name='User.proto',
  package='',
  serialized_pb='\n\nUser.proto\x1a\x0e\x42\x61\x63kpack.proto\"Z\n\x04User\x12\x11\n\ttimestamp\x18\x01 \x01(\x05\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x0e\n\x06\x61vatar\x18\x03 \x01(\x05\x12\r\n\x05level\x18\x04 \x01(\x05\x12\x12\n\nexperience\x18\x05 \x01(\x05\x42%\n\x18\x63om.kloomba.app.protobufB\tUserProto')
...
_USER = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='level', full_name='User.level', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='experience', full_name='User.experience', index=4,
